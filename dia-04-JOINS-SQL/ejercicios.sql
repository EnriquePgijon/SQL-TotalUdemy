...
select series.titulo as 'Titulo de la serie', episodios.titulo as 'titulo de episodio' from series
left join episodios on series.serie_id= episodios.serie_id order by series.titulo;

Select series.titulo as 'Titulo de la serie', episodios.titulo as 'titulo episodio' from episodios
right join series on episodios.serie_id = series.serie_id order by series.titulo;
